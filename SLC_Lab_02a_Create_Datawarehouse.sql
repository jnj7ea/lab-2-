...
SELECT o.OrderID, o.CustomerID, o.OrderDate, od.ProductID, od.UnitPrice, od.Quantity, ods.Status, os.StatusDescription
FROM Northwind.orders o
JOIN Northwind.order_details od ON o.OrderID = od.OrderID
JOIN Northwind.order_details_status ods ON od.OrderDetailID = ods.OrderDetailID
JOIN Northwind.orders_status os ON ods.Status = os.Status;
